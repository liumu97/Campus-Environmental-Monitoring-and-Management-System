...
#define SET_SPI_CS  	GPIOA->ODR |= (1<<4)		//把PA4升为高电平(PA4=1)
#define CLR_SPI_CS  	GPIOA->ODR &= ~(1<<4)	  //把PA4降为低电平(PA4=0)
#define SET_RC522RST  	GPIOB->ODR |= (1<<1)		//把PB1升为高电平(PB1=1)
#define CLR_RC522RST  	GPIOB->ODR &= ~(1<<1) 	  //把PB1降为低电平(PB1=0)
